...
namespace SASedWarp
{
	...
	[BepInPlugin("SASed-Warp", "SASed Warp", "0.2.1")]
	...
	public class SASedWarpPlugin : BaseSpaceWarpPlugin
	{
		...
		public void Update()
		{
			...
			var telemetry = (TelemetryComponent)autopilot.GetType().GetField("_telemetry", BindingFlags.Instance|BindingFlags.NonPublic).GetValue(autopilot);
			Vector targ_forward;
